...
public class Executa implements MetodosAnimais<NoArvore> {
    ...
    public void inserir(NoArvore no) {
       ...
       //Se o botão "Cancelar" for acionado, aparece a mensagem pedindo para informar algum valor.
        ...
        String verbo = JOptionPane.showInputDialog("Um(a) " + animal + "______ mas um(a) " + no.valor + " não.");
        
        //Se o botão "Cancelar" for acionado, aparece a mensagem pedindo para informar algum valor.
        while (verbo == null) {
            JOptionPane.showMessageDialog(null, "Informe algum valor");
            verbo = JOptionPane.showInputDialog("Um(a) " + animal + "______ mas um(a) " + no.valor + " não.");
        }
    ...
    public void perguntar(NoArvore no) {
        ...
        int pergunta = JOptionPane.showConfirmDialog(null, "O animal que você pensou " + no.valor + "?", "Confirme",
